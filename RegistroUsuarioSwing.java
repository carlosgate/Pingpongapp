...
public class RegistroUsuarioSwing extends JPanel {
    ...
    public RegistroUsuarioSwing(CardLayout cardLayout, JPanel panelPrincipal) {
        ...
        gbc.gridx = 1; gbc.gridy = 3; gbc.gridwidth = 2; gbc.anchor = GridBagConstraints.WEST;
        add(volverBtn, gbc);
    ...
    private void registrarUsuario() {
        try {
            String nombre = nombreField.getText();            int edad = Integer.parseInt(edadField.getText());
    ...
    public int getEdad() {
    	try{return Integer.parseInt(edadField.getText().trim());}
